...
def generate_token(email : str, id : str, role : str, delta: timedelta = timedelta(days=3)):
    payload = {"sub": email, "id": id, "role": role, "exp": time.time() + delta.total_seconds() + (ACCESS_TOKEN_EXPIRE_MINUTES * 60)}
